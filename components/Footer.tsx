        ...
        <div className="-m-6 flex flex-wrap">
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              ...
              <ul>
                <li className="mb-4">
                  <Link className=" text-base font-medium text-gray-900 dark:text-white dark:fill-white  hover:text-gray-700" href="https://x.com/quillsmedia_?t=Z-8jJEFRF311OittLEGKTw&s=09">
                ...
                <li className="mb-4">
                  <Link className=" text-base font-medium text-gray-900 dark:text-white dark:fill-white  hover:text-gray-700" href="https://www.instagram.com/quillsmedia_/">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 30 30">
                ...
                <li className="mb-4">
                  <Link className=" text-base font-medium text-gray-900 dark:text-white dark:fill-white  hover:text-gray-700" href="https://www.linkedin.com/in/quills-media-700840309/">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 30 30">
                ...
                <li>
                  <Link className=" text-base font-medium text-gray-900 dark:text-white dark:fill-white  hover:text-gray-700" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 30 30">
